"""
Django settings for BINNA project.
...
import os
import environ  # استيراد مكتبة إدارة المتغيرات البيئية

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent

# ── تهيئة وقراءة ملف .env ──────────────────────────────────
env = environ.Env(
    # قيم افتراضية احتياطية في حال عدم وجود المتغير في ملف .env
    DEBUG=(bool, False)
)
...
# قراءة مفتاح الـ Django السري بأمان من ملف الـ .env
...
WSGI_APPLICATION = 'BINNA.wsgi.application'
